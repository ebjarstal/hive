...
protected:
    Partie& partie;
    std::vector<Pion*> pionsEnMain;
    std::string couleur;
    std::string nom;
    unsigned int nbUndo;
    Joueur(std::vector<Pion*> pEm, std::string c, Partie& p, std::string n, unsigned int nb); // uniquement Partie peut le creer et avec param car extension
public:
    ...
    std::vector<Pion*>& getPionsEnMain() { return pionsEnMain; }
...
public:
    JoueurHumain(std::string n, std::vector<Pion*> pionsEnMain, std::string couleur, unsigned int nb, Partie& p) : Joueur(pionsEnMain, couleur, p, n, nb) {}
...
public:
    JoueurIA(std::string n, std::vector<Pion*> pionsEnMain, std::string couleur, Partie& p, unsigned int nb) : Joueur(pionsEnMain, couleur, p, n, nb) {}
    void Jouer(Plateau& plateau, Partie& partie) override;
